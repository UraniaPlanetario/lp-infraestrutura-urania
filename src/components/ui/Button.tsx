...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg font-body transition-all duration-200 cursor-pointer focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        accent:
          "bg-accent text-accent-foreground border-2 border-primary/60 hover:shadow-[0_0_20px_rgba(139,92,246,0.4)] font-semibold",
        hero: "bg-accent text-accent-foreground border-2 border-primary/60 hover:shadow-[0_0_20px_rgba(139,92,246,0.4)] font-bold animate-pulse-glow",
        default:
